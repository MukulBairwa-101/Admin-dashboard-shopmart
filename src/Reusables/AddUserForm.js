...
import {FaUser,MdFingerprint,  FaEye,FaEyeSlash} from "./Icons";
...
const AddUserForm = () => {
    ...
    const {users,setUsers,editingUser,rowId} = appContext;
    ...
    return (
        <div className="user-form-container">
            <form className="user-form" onSubmit={addingUser}>
                ...
                <div>
                    <button type="submit" className="btn" onClick={save}>Save</button>
                </div>    
        </div>
    )
}
